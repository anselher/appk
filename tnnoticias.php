...
<head>
<meta charset="utf-8">
<title>TEVEVISION | TN NOTICIAS</title>
...
<body>
<div id="container">
<div id="wb_EmbeddedPageTNNOTICIAS" style="position:absolute;left:0px;top:0px;width:1029px;height:1518px;z-index:23;">
...
<!-- cortesiax -->
<div id="Html3" style="position:absolute;left:0px;top:0px;width:30px;height:24px;z-index:24">
<body onload="window.open('tnnoticiasplay','InlineFrameScreen');window.open('info-canal-tnnoticias','InlineFrameInfoChannel');window.open('logo-canal-tnnoticias','InlineFrameLogoChannel');window.open('./images/flags/flag-argentina','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
