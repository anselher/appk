...
<body>
<div id="container">
<div id="wb_EmbeddedPage1DW" style="position:absolute;left:0px;top:0px;width:872px;height:606px;z-index:23;">
...
<!-- INFOCHANNEL -->
<div id="dwenespanolHtml1" style="position:absolute;left:0px;top:0px;width:31px;height:32px;z-index:24">
<body onload="window.open('dwenespanolplay','InlineFrameScreen');window.open('info-canal-dwenespanol','InlineFrameInfoChannel');window.open('logo-canal-dwenespanol','InlineFrameLogoChannel');window.open('./images/flags/flag-alemania','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
