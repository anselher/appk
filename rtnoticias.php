...
<head>
<meta charset="utf-8">
<title>TEVEVISION | RT NOTICIAS</title>
...
<body>
<div id="container">
<div id="wb_EmbeddedPagertnoticias" style="position:absolute;left:0px;top:0px;width:872px;height:606px;z-index:23;">
...
<!-- INFOCHANNEL -->
<div id="rtnoticiasHtml1" style="position:absolute;left:0px;top:0px;width:31px;height:32px;z-index:24">
<body onload="window.open('rtnoticiasplay','InlineFrameScreen');window.open('info-canal-rtnoticias','InlineFrameInfoChannel');window.open('logo-canal-rtnoticias','InlineFrameLogoChannel');window.open('./images/flags/flag-rusia','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
<div id="menumasterplayer2">
</div>
<div id="wb_BreadcrumbMenu1">
   <ul id="BreadcrumbMenu1">
      <li><a href="opcion-1" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 1" onclick="window.open('rtnoticiasplay','InlineFrameScreen');return false;">OPCION 1</a></li>
      <li><a href="opcion-2" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 2" onclick="window.open('rtnoticiasplay2','InlineFrameScreen');return false;">OPCION 2</a></li>
      <li><a href="opcion-3" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 3" onclick="window.open('rtnoticiasplay3','InlineFrameScreen');return false;">OPCION 3</a></li>
   </ul>
</div>
