...
<link href="vrtv.css?v=249" rel="stylesheet">
...
<body>
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb17.png" alt="WYSIWYG Web Builder" style="position:absolute;left:755px;top:0px;margin: 0;border-width:0;z-index:250" width="16" height="16"></a>
<div id="page2Html1" style="position:absolute;left:0px;top:0px;width:728px;height:409px;z-index:1">
<body onload="window.open('info-channel','InlineFrameInfoChannel');window.open('logo-channel-index','InlineFrameLogoChannel');window.open('./images/status-channel/status-live','InlineFrameStatusLive');return false;">
<div id="player"></div>
    <script>
      var player = new Clappr.Player(
        {
          source: 'https://cdn-ue1-prod.tsv2.amagi.tv/linear/amg01024-olympusat-cinereallatam-ono/playlist.m3u8',
          parentId: '#player',
