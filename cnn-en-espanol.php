...
<head>
<meta charset="utf-8">
<title>TEVEVISION | CNN en Español</title>
...
<link href="vrtv.css?v=221" rel="stylesheet">
<style>
...
<div id="container">
<div id="wb_EmbeddedPageCNNESPA" style="position:absolute;left:0px;top:0px;width:1029px;height:1018px;z-index:23;">
...
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb17.png" alt="WYSIWYG Web Builder" style="position:absolute;left:711px;top:584px;margin: 0;border-width:0;z-index:250" width="16" height="16"></a>
<!-- cajon -->
<div id="infopage" style="position:absolute;left:0px;top:0px;width:42px;height:27px;z-index:25">
<body onload="window.open('cnnenespanolplay','InlineFrameScreen');window.open('info-channelcnn','InlineFrameInfoChannel');window.open('logochannelcnn','InlineFrameLogoChannel');window.open('./images/flags/flag-eeuu','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
<div id="menumasterplayer2">
<div id="wb_BreadcrumbMenu1">
   <ul id="BreadcrumbMenu1">
      <li><a href="opcion-1" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 1" onclick="window.open('fd','InlineFrameScreen');return false;">OPCION 1</a></li>
      <li><a href="opcion-2" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 2" onclick="window.open('d','InlineFrameScreen');return false;">OPCION 2</a></li>
      <li><a href="opcion-3" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 3" onclick="window.open('d','InlineFrameScreen');return false;">OPCION 3</a></li>
   </ul>
</div>
</div>
