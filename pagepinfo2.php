...
<link href="pagepinfo2.css" rel="stylesheet">
...
<body onload="window.open('pagep2','InlineFrameScreen');return false;">
<div id="space"><br></div>
<div id="container">
...
<div id="wb_EmbeddedPageTHEBATMAN" style="position:absolute;left:0px;top:0px;width:872px;height:606px;z-index:15;">
...
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb17.png" alt="WYSIWYG Web Builder" style="position:absolute;left:0px;top:0px;margin: 0;border-width:0;z-index:250" width="16" height="16"></a>
<iframe name="InlineFrameSidebar2" id="InlineFrameSidebar2" class="h6" style="position:absolute;left:631px;top:183px;width:238px;height:389px;z-index:12;" src="./menu_mov.php" scrolling="no"></iframe>
...
<!-- cajon -->
<div id="Html3" style="position:absolute;left:0px;top:0px;width:38px;height:34px;z-index:16">
<img class="logoserie" src="https://media.fstatic.com/d2_BL9MLRx4Cuc_bjaia-PTDm4g=/290x478/smart/media/movies/covers/2020/11/THE-BATMAN-Poster.jpg">
...
<h5><p>THE BATMAN<br>ROBERT PATTINSON<br>2022</p></h5>
<h5><p2>THE BATMAN</p2></h5></div>
</div>
</body>
</html>