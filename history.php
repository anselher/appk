...
<head>
<meta charset="utf-8">
<title>TEVEVISION | History</title>
...
<link href="vrtv.css?v=216" rel="stylesheet">
<style>
...
#FlexGrid1
{
   ...
   grid-template-rows: auto 90px 1px 30px 1px 19px 30px 1px 20px 1px 338px 1px 30px 1px 90px 1px 30px minmax(1px,auto) 161px 1px 30px 1px auto auto;
   grid-template-areas:
      ". . . . . . . . ."
...
>
<div id="container">
<div id="wb_EmbeddedPageTVES" style="position:absolute;left:0px;top:0px;width:1029px;height:1518px;z-index:22;">
<div id="wb_EmbeddedPage1" style="position:absolute;left:0px;top:0px;width:1029px;height:1518px;z-index:14;">
...
<div id="wb_BreadcrumbNot" style="position:absolute;left:0px;top:114px;width:729px;height:30px;z-index:15;vertical-align:top;">
<ul id="BreadcrumbNot">
...
<!-- menuplay1 -->
<div id="menuplay1" style="position:absolute;left:0px;top:0px;width:73px;height:34px;z-index:18">
...
<!-- cortesiax -->
<div id="Html3" style="position:absolute;left:0px;top:0px;width:30px;height:31px;z-index:23">
<body onload="window.open('historyplay1','InlineFrameScreen');window.open('info-canal-history','InlineFrameInfoChannel');window.open('logo-canal-history','InlineFrameLogoChannel');window.open('./images/flags/flag-eeuu','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='block';document.getElementById('menumasterplayer2').style.display='block';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
<div id="menumasterplayer2">
</div>
<div id="wb_BreadcrumbMenu1">
   <ul id="BreadcrumbMenu1">
      <li><a href="opcion-1" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 1" onclick="window.open('historyplay1','InlineFrameScreen');return false;">HISTORY 1</a></li>
      <li><a href="opcion-2" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 2" onclick="window.open('historyplay2','InlineFrameScreen');return false;">HISTORY 1</a></li>
      <li><a href="opcion-2" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 2" onclick="window.open('history2play1','InlineFrameScreen');return false;">HISTORY 2</a></li>
      <li><a href="opcion-2" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 2" onclick="window.open('history2play2','InlineFrameScreen');return false;">HISTORY 2</a></li>
