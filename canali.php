...
<head>
<meta charset="utf-8">
<title>TEVEVISION | Canal i</title>
...
<body onload="window.open('canaliplay','InlineFrameScreen');window.open('info-canal-canali','InlineFrameInfoChannel');window.open('logo-canal-canali','InlineFrameLogoChannel');window.open('./images/flags/flag-venezuela','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='block';document.getElementById('menumasterplayer2').style.display='block';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
