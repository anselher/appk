...
<iframe allow="encrypted-media" allow="popups" allow="same-origin" width="630px" height="360px" src='https://telefullenvivo.com/canales/dmax/' name="iframe" frameborder="0" scrolling="no" allowfullscreen></iframe>
 <!-- Here is the <div> for the player -->
 <!doctype html>
<html>
<head>
...
<link href="dmaxplay.css" rel="stylesheet">
