...
<head>
<meta charset="utf-8">
<title>TEVEVISION | France 24</title>
...
<body>
<div id="container">
<div id="wb_EmbeddedPageFrance24" style="position:absolute;left:0px;top:0px;width:1029px;height:1518px;z-index:23;">
...
<!-- INFOCHANNEL -->
<div id="france24Html1" style="position:absolute;left:0px;top:0px;width:31px;height:32px;z-index:24">
<body onload="window.open('france24play','InlineFrameScreen');window.open('info-canal-france24','InlineFrameInfoChannel');window.open('logo-canal-france24','InlineFrameLogoChannel');window.open('./images/flags/flag-francia','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
