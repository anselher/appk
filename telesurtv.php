...
<head>
<meta charset="utf-8">
<title>TEVEVISION | TELESUR</title>
...
<link href="vrtv.css?v=212" rel="stylesheet">
<style>
...
<body>
<div id="container">
<div id="wb_EmbeddedPagetelesur" style="position:absolute;left:0px;top:0px;width:1029px;height:1518px;z-index:23;">
...
<div class="sidebar3">
<iframe name="InlineFrameSidebar2" id="InlineFrameSidebar2" class="h6" src="./menu_not" scrolling="no"></iframe>
</div>
...
<!-- INFOCHANNEL -->
<div id="Html1" style="position:absolute;left:0px;top:0px;width:31px;height:32px;z-index:24">
<body onload="window.open('telesurtvplay','InlineFrameScreen');window.open('info-canal-telesur','InlineFrameInfoChannel');window.open('logo-canal-telesur','InlineFrameLogoChannel');window.open('./images/flags/flag-venezuela','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
<div id="menumasterplayer2">
</div>
<div id="wb_BreadcrumbMenu1">
   <ul id="BreadcrumbMenu1">
      <li><a href="opcion-1" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 1" onclick="window.open('telesurtvplay','InlineFrameScreen');return false;">OPCION 1</a></li>
      <li><a href="opcion-2" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 2" onclick="window.open('telesurtvplay2','InlineFrameScreen');return false;">OPCION 2</a></li>
      <li><a href="opcion-3" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 3" onclick="window.open('telesurtvplay3','InlineFrameScreen');return false;">OPCION 3</a></li>
   </ul>
</div>
