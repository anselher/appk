    ...
    <div id="wrapper">
        <div id="scroller">
            <ul>
                ...
                <li><a href="javascript:void(0);" onclick="javascript:window.open('cinecanal', '_top'); "><img src="https://www.totalmedios.com/img/noticias/2018/09/5b965cd2a443c__838x390.jpg"><h5> CINECANAL<h5></a></li>
