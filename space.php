...
<link href="vrtv.css?v=214" rel="stylesheet">
<style>
...
<body onload="window.open('spaceplay1','InlineFrameScreen');window.open('info-canal-space','InlineFrameInfoChannel');window.open('logo-canal-space','InlineFrameLogoChannel');window.open('./images/flags/flag-eeuu','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='block';document.getElementById('menumasterplayer2').style.display='block';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
<div id="menumasterplayer2">
</div>
<div id="wb_BreadcrumbMenu1">
   <ul id="BreadcrumbMenu1">
      <li><a href="opcion-1" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 1" onclick="window.open('spaceplay1','InlineFrameScreen');return false;">OPCION 1</a></li>
      <li><a href="opcion-2" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 2" onclick="window.open('spaceplay2','InlineFrameScreen');return false;">OPCION 2</a></li>
