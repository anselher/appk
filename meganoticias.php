...
<!-- cortesiax -->
<div id="Html3" style="position:absolute;left:0px;top:0px;width:33px;height:28px;z-index:24">
<body onload="window.open('meganoticiasplay','InlineFrameScreen');window.open('info-canal-meganoticias','InlineFrameInfoChannel');window.open('logo-canal-meganoticias','InlineFrameLogoChannel');window.open('./images/flags/flag-chile','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
