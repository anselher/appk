...
<head>
<meta charset="utf-8">
<title>365TV | THE EPOCH TIMES</title>
...
<div id="space"><br></div>
<div id="container">
<div id="wb_EmbeddedPageTheEpochT" style="position:absolute;left:0px;top:0px;width:872px;height:606px;z-index:23;">
...
<!-- INFOCHANNEL -->
<div id="the-epoch-timeHtml1" style="position:absolute;left:0px;top:0px;width:31px;height:32px;z-index:24">
<body onload="window.open('tetplay','InlineFrameScreen');window.open('info-canal-tet','InlineFrameInfoChannel');window.open('logo-canal-tet','InlineFrameLogoChannel');window.open('./images/flags/flag-eeuu','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
<div id="wb_BreadcrumbMenu1">
   <ul id="BreadcrumbMenu1">
      ...
      <li><a href="opcion-2" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 2" onclick="window.open('tetplay2','InlineFrameScreen');return false;">OPCION 2</a></li>
      <li><a href="opcion-3" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 3" onclick="window.open('tetplay3','InlineFrameScreen');return false;">OPCION 3</a></li>
      <li><a href="opcion-3" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 3" onclick="window.open('tubemote','InlineFrameScreen');return false;">OPCION 4</a></li>
   </ul>
</div>
