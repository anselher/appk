...
<head>
<meta charset="utf-8">
<title>TEVEVISION | C5N NOTICIAS</title>
...
<body>
<div id="container">
<div id="wb_EmbeddedPageC5n" style="position:absolute;left:0px;top:0px;width:872px;height:606px;z-index:23;">
...
<!-- INFOCHANNEL -->
<div id="c5nnoticiasHtml1" style="position:absolute;left:0px;top:0px;width:31px;height:32px;z-index:24">
<body onload="window.open('c5nnoticiasplay','InlineFrameScreen');window.open('info-canal-c5nnoticias','InlineFrameInfoChannel');window.open('logo-canal-c5nnoticias','InlineFrameLogoChannel');window.open('./images/flags/flag-argentina','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
