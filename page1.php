...
<link href="fullscreen2.css?v=289" rel="stylesheet">
<style>
    ...
    <div id="wrapper">
        <div id="scroller">
            <ul>
                ...
                <li><a href="canal/france24" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="" onclick="window.open('vtv', '_top'); "><img src="https://s1.dmcdn.net/v/SZNmq1Ve3YFARIK5d/x240" class="imgmenu"><br><h5>VTV</h5></a></li>
...
<script type='text/javascript'>
 ...
 sources: [
     {file: "https://vcp.myplaytv.com/canali/canali/playlist.m3u8"},
   {file: "https://vcp.myplaytv.com/canali/canali/playlist.m3u8"}
    ],
 rtmp: {
  bufferlength: 3,
