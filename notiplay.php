...
<body>
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb17.png" alt="WYSIWYG Web Builder" style="position:absolute;left:749px;top:0px;margin: 0;border-width:0;z-index:250" width="16" height="16"></a>
<div id="player"></div>
    <script>
      var player = new Clappr.Player(
        {
          source: 'https://cdn-ue1-prod.tsv2.amagi.tv/linear/amg01024-olympusat-flash-ono/playlist.m3u8',
          parentId: '#player',
