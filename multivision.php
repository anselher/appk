...
<head>
<meta charset="utf-8">
<title>TEVEVISION | Multivision</title>
...
<!-- cortesiax -->
<div id="Html3">
<body onload="window.open('multivisionplay','InlineFrameScreen');window.open('info-canal-multivision','InlineFrameInfoChannel');window.open('logo-canal-multivision','InlineFrameLogoChannel');window.open('./images/flags/flag-argentina','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='block';document.getElementById('menumasterplayer2').style.display='block';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
