...
<body>
<div id="container">
<div id="wb_EmbeddedPageVpitv" style="position:absolute;left:0px;top:0px;width:872px;height:1160px;z-index:23;">
...
<!-- INFOCHANNEL -->
<div id="Html1" style="position:absolute;left:0px;top:0px;width:45px;height:36px;z-index:24">
<body onload="window.open('vpitvplay','InlineFrameScreen');window.open('info-canal-vpitv','InlineFrameInfoChannel');window.open('logo-canal-vpitv','InlineFrameLogoChannel');window.open('./images/flags/flag-venezuela','InlineFrameFlags');window.open('./images/status-channel/status-vod-activ','InlineFrameStatusVod');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
