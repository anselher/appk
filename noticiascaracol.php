...
<head>
<meta charset="utf-8">
<title>TEVEVISION | Noticias Caracol</title>
...
<body>
<div id="container">
<div id="wb_EmbeddedPageNotiCarac" style="position:absolute;left:0px;top:0px;width:872px;height:606px;z-index:23;">
...
<!-- INFOCHANNEL -->
<div id="noticiascaracolHtml1" style="position:absolute;left:0px;top:0px;width:31px;height:32px;z-index:24">
<body onload="window.open('noticiascaracolplay','InlineFrameScreen');window.open('info-canal-noticiascaracol','InlineFrameInfoChannel');window.open('logo-canal-noticiascaracol','InlineFrameLogoChannel');window.open('./images/flags/flag-colombia','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
<div id="menumasterplayer2">

<div id="wb_BreadcrumbMenu1">
   <ul id="BreadcrumbMenu1">
      <li><a href="opcion-1" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 1" onclick="window.open('dwenespanolplay','InlineFrameScreen');return false;">OPCION 1</a></li>
      <li><a href="opcion-2" rel="nofollow noopener noreferrer sponsored ugc" target="InlineFrameScreen" title="Opcion 2" onclick="window.open('dwenespanolplay2','InlineFrameScreen');return false;">OPCION 2</a></li>
