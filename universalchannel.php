...
<!-- cortesiax -->
<div id="Html3">
<body onload="window.open('universalplay1','InlineFrameScreen');window.open('info-canal-universal','InlineFrameInfoChannel');window.open('logo-canal-universal','InlineFrameLogoChannel');window.open('./images/flags/flag-eeuu','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='block';document.getElementById('menumasterplayer2').style.display='block';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
