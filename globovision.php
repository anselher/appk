...
<head>
<meta charset="utf-8">
<title>TEVEVISION | Globovision</title>
...
<body>
<div id="container">
<div id="wb_EmbeddedPageGlobov" style="position:absolute;left:0px;top:0px;width:1029px;height:1518px;z-index:23;">
...
<!-- INFOCHANNEL -->
<div id="globovisionHtml1" style="position:absolute;left:0px;top:0px;width:87px;height:32px;z-index:24">
<body onload="window.open('globovisionplay','InlineFrameScreen');window.open('info-canal-globovision','InlineFrameInfoChannel');window.open('logo-canal-globovision','InlineFrameLogoChannel');window.open('./images/flags/flag-venezuela','InlineFrameFlags');window.open('./images/status-channel/status-live','InlineFrameStatusLive');document.getElementById('menumasterplayer').style.display='none';document.getElementById('menumasterplayer2').style.display='none';document.getElementById('wb_BreadcrumbMenuCentral').style.display='block';return false;">
