...
<iframe allow="encrypted-media" allow="popups" allow="same-origin" width="100%" height="100%" src='https://goalmatch.webcindario.com/ek2.php?ch=starchannel' name="iframe" frameborder="0" scrolling="no" allowfullscreen></iframe>
 <!-- Here is the <div> for the player -->
<!doctype html>
<html>
<head>
