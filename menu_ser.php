    ...
    <div id="wrapper">
        <div id="scroller">
            <ul>
                ...
                <li><a href="javascript:void(0);" onclick="javascript:window.open('tntseries', '_top'); "><img src="https://i.ytimg.com/vi/UEH4krgdJks/maxresdefault.jpg"><h5> TNT SERIES</h5></a></li>
